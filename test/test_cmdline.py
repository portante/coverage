...
class CmdLineTest(CoverageTest):
    ...
    INIT_LOAD = """\
        .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=None)
        .load()\n"""
...
class ClassicCmdLineTest(CmdLineTest):
    ...
    def test_execute(self):
        ...
        self.cmd_executes("-x --timid foo.py abc 123", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=True, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=None)
            .load()
            .start()
        ...
        self.cmd_executes("-x -p -L foo.py -a -b", """\
            .coverage(cover_pylib=True, data_suffix=True, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=None)
            .load()
            .start()
    ...
    def test_report(self):
        ...
        self.cmd_executes("-r -o fooey", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=["fooey"])
            .load()
            .report(ignore_errors=None, omit=["fooey"], include=None,
                    morfs=[], show_missing=None)
            """)
        self.cmd_executes("-r -o fooey,booey", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=["fooey", "booey"])
            .load()
...
class NewCmdLineTest(CmdLineTest):
    ...
    def test_run(self):
        ...
        self.cmd_executes("run --branch foo.py", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=True, config_file=True, source=None, include=None, omit=None)
            .erase()
            .start()
            .run_python_file('foo.py', ['foo.py'])
            .stop()
        ...
        self.cmd_executes("run --rcfile=myrc.rc foo.py", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file="myrc.rc", source=None, include=None, omit=None)
            .erase()
            .start()
            .run_python_file('foo.py', ['foo.py'])
            .stop()
        ...
        self.cmd_executes("run --include=pre1,pre2 foo.py", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=["pre1", "pre2"], omit=None)
            .erase()
            .start()
            .run_python_file('foo.py', ['foo.py'])
            .stop()
        ...
        self.cmd_executes("run --omit=opre1,opre2 foo.py", """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None, concurrency='threads', branch=None, config_file=True, source=None, include=None, omit=["opre1", "opre2"])
            .erase()
            .start()
            .run_python_file('foo.py', ['foo.py'])
            .stop()
        ...
        self.cmd_executes("run --include=pre1,pre2 --omit=opre1,opre2 foo.py",
            ...
            .coverage(cover_pylib=None, data_suffix=None, timid=None,
                concurrency='threads', branch=None, config_file=True, source=None,
                include=["pre1", "pre2"],
                omit=["opre1", "opre2"])
            .erase()
            .start()
        ...
        self.cmd_executes("run --source=quux,hi.there,/home/bar foo.py",
            """\
            .coverage(cover_pylib=None, data_suffix=None, timid=None,
                concurrency='threads', branch=None, config_file=True,
